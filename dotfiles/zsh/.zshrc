...
alias dotfiles="dotdrop --cfg=$DOTFILES/config.yaml -f install --profile=disconnect"
alias sudotfiles="sudo dotdrop --cfg=$DOTFILES/root-config.yaml -f install --profile=disconnect"
alias dot="dotfiles"
